...
<table width="500" border="1" cellspacing="0" cellpadding="0" align="center">  
  ...
  <tr height="30">      
   ...
   <input type="button" value="글삭제" 
       onclick="document.location.href='../community/deleteForm.jsp?num=<%=article.getNum()%>&pageNum=<%=pageNum%>'">
     <!-- num ,pagenum값을 가지고 deleteForm.jsp로 넘어간다 -->
    &nbsp;&nbsp;&nbsp;&nbsp;
      <input type="button" value="답글쓰기" 
       onclick="document.location.href='../community/writeForm.jsp?num=<%=num%>&ref=<%=ref%>&re_step=<%=re_step%>&re_level=<%=re_level%>'">
